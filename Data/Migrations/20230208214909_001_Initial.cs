...
namespace ToDoListQuiz.Data.Migrations
{
    /// <inheritdoc />
    public partial class _001Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessoryToDoItem", x => new { x.AccessoryId, x.ToDoItemId });
                    table.ForeignKey(
                        name: "FK_AccessoryToDoItem_Accessory_AccessoryId",
                        column: x => x.AccessoryId,
                        principalTable: "Accessory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccessoryToDoItem_ToDoItem_ToDoItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessoryToDoItem_ToDoItemId",
